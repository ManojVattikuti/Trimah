...
const Why = () => {
  ...
  return (
    <section className="bg-[#f0f4fd] bg-opacity-50 py-16  px-8 lg:px-32">
      <div className="container mx-auto flex flex-col items-center">
        <h2 className="text-3xl font-bold text-center capitalize leading-10">
          Why Trimah Technologies
        </h2>
        <p className="text-[#5a5e6a] lg:text-base font-normal text-[15px]  text-center mb-8 capitalize leading-7">
