...
const ServiceSection = () => {
  ...
  return (
    <section className="py-16 px-4 sm:py-24 sm:px-8 lg:py-32 lg:px-32">
      <div className="container mx-auto relative">
        {/* Explore More Link (Top for PC/Tab) */}
        ...
        <p className="text-sm sm:text-base lg:text-lg mb-8 text-gray-500">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8 mb-4">
          ...
          >
            <img
              ...
              alt="IT Consulting"
              className={`w-full h-60 sm:h-72 lg:h-80 object-cover transition-transform duration-300 ${
                hoveredService === 'consulting' ? 'scale-110' : ''
              }`}
            />
            <div className="absolute inset-0 flex items-end justify-start p-4 sm:p-6">
              <div className="text-left bg-[#684fa3] text-white px-2 py-2 rounded-lg">
                <h3 className="text-white text-sm sm:text-base lg:text-lg font-semibold font-['Maven Pro'] mb-2">
                  IT Consulting
                </h3>
                {hoveredService === 'consulting' && (
              ...
              <div
                className={`absolute top-4 right-4 p-2 rounded-full bg-black bg-opacity-50 text-white transition-opacity duration-300 ${
                  hoveredService === 'consulting' ? 'opacity-100' : 'opacity-0'
                }`}
              >
          ...
          <div
            className={`relative overflow-hidden rounded-lg shadow-md transition-all duration-300 ${
              hoveredService === 'staff' ? 'scale-105' : hoveredService ? 'scale-95' : ''
            }`}
          ...
          >
            <img
              ...
              className={`w-full h-60 sm:h-72 lg:h-80 object-cover transition-transform duration-300 ${
                hoveredService === 'staff' ? 'scale-110' : ''
              }`}
            />
            <div className="absolute inset-0 flex items-end justify-start p-4 sm:p-6">
              <div className="text-left bg-[#24c79b] text-black px-2 py-2 rounded-lg">
                <h3 className="text-black text-sm sm:text-base lg:text-lg font-semibold font-['Maven Pro'] mb-2">
                  Staff Augmentation
                </h3>
              ...
              <div
                className={`absolute top-4 right-4 p-2 rounded-full bg-white bg-opacity-50 text-white transition-opacity duration-300 ${
                  hoveredService === 'staff' ? 'opacity-100' : 'opacity-0'
                }`}
              >
                <a href="#" className="flex items-center justify-center">
                  <FiArrowRight className="w-5 h-5" />
        ...
        {/* Explore More Link (Bottom for Mobile) */}
