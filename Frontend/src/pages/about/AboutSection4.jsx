...
const AboutSection4 = () => {
  return (
    <section className='lg:px-32 '>
      ...
      <div className="px-8 max-w-full bg-violet-100 rounded-3xl w-auto max-md:px-16 max-md:mt-10">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[76%] max-md:ml-0 max-md:w-full">
            <div className="flex z-10 flex-col items-start self-stretch my-auto max-md:mt-10 max-md:max-w-full">
              <div className="text-2xl sm:text-3xl lg:text-2xl font-semibold font-parkinsans leading-none uppercase ">
                What We Do
              </div>
              <div className="self-stretch mt-1 text-2xl leading-10 text-black max-md:max-w-full">
                ...
                <span className="font-extrabold font-parkinsans text-[#684fa3]">
                  Trimah Technologies
                </span>
