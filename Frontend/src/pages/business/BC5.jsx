export const BC5=()=>{
    return(
        <div className="w-[1440px] h-[874px] py-2">
             <div className="w-[1354px] h-[683.94px] left-0 top-[2514px] absolute">
      <div className="w-[695.21px] h-[683.94px] left-0 top-0 absolute  overflow-hidden">
        <div className="w-[683px] h-[683px] left-[-179px] top-[1px] absolute bg-[#e4d9ff] rounded-full" />
        <div className="w-16 h-16 left-[591px] top-[217px] absolute flex-col justify-start items-start flex overflow-hidden" />
        <div className="w-[54px] h-[54px] left-[597px] top-[408px] absolute  overflow-hidden" />
        <div className="w-[54px] h-[54px] left-[597px] top-[585px] absolute flex-col justify-start items-start flex overflow-hidden" />
        <div className="w-[342px] h-[284px] left-[72px] top-[201px] absolute">
          <div className="w-[342px] h-[152px] left-0 top-0 absolute">
            <div className="w-[342px] left-0 top-[72px] absolute text-[#292929] text-3xl font-normal font-['Gilroy-Bold'] capitalize leading-10">Consulting Engagement Process</div>
            <div className="w-[60px] h-[60px] left-0 top-0 absolute flex-col justify-start items-start inline-flex overflow-hidden" />
          </div>
          <div className="w-[334px] left-0 top-[158px] absolute text-[#505050]/70 text-base font-normal font-['Gilroy-Medium'] leading-[30.56px]">Our proven process ensures a seamless and effective consulting experience</div>
          <div className="w-[287px] h-14 left-0 top-[228px] absolute">
            <div className="w-[287px] h-14 left-0 top-0 absolute bg-[#6fd1ab] rounded-[87px] shadow-[inset_0px_0px_4px_2px_rgba(0,0,0,0.25)]" />
            <div className="w-[229.12px] h-[18px] left-[29px] top-[19px] absolute">
              <div className="left-0 top-0 absolute"><span class="text-[#1b1b1b] text-[15px] font-semibold font-['Maven Pro'] capitalize">Schedule </span><span class="text-[#1b1b1b] text-[15px] font-semibold font-['Maven Pro'] lowercase">a</span><span class="text-[#1b1b1b] text-[15px] font-semibold font-['Maven Pro'] capitalize"> Free Consultation</span></div>
            </div>
          </div>
        </div>
      </div>
