export const BC7 = () => {
  return (
    <div className="py-16 sm:py-32">
      <h1 className="text-2xl sm:text-3xl font-bold text-center mb-8">What Sets Us Apart</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4 px-8 sm:px-32 py-2">
        ...
        <div className="h-60 sm:h-80 flex items-center justify-center bg-red-500 text-white font-bold text-lg rounded-lg shadow-lg relative hover:scale-105 transition-all duration-300 ease-in-out transform">
