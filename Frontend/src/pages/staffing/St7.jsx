  ...
  return (
    <div className="flex relative flex-col justify-center items-center self-stretch px-20 py-24 mt-9 w-full text-base min-h-[377px] max-md:px-5 max-md:max-w-full">
      ...
      <div className="flex relative flex-col items-center max-w-full w-[616px]">
        <div className="px-3 py-1.5 w-44  font-parkinsans max-w-full leading-none text-emerald-400 uppercase rounded-2xl bg-emerald-400 bg-opacity-20">
          WANT TO REACH US
        </div>
        ...
        Let Trimah Technologies connect you with the right talent to {" "}
          <span className=" text-[#684fa3] font-bold">Industry? </span>{" "}
